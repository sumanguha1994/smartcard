<footer class="footer">
        <div class="container-fluid">
          <div class="copyright float-right">
            ...
            <a href="http://onedesigns.co.in//" target="_blank">Webuilder</a> for a better web.
          </div>
        </div>
      </footer>
    </div>
  ...
  <script src="<?= base_url('assets/js/material-dashboard.min1c51.js?v=2.1.2');?>" type="text/javascript"></script>
